    ...
    testWidgets('renders initially expanded item', (tester) async {
      await tester.pumpWidget(Harness(
        child: SizedBox(
          width: 400,
          child: DievasAccordion(items: [
            DievasAccordionItem(title: const Text('Item 1'), content: const Text('Content 1'), initiallyExpanded: true),
          ]),
        ),
      ));
      await tester.pumpAndSettle();
    ...
    testWidgets('hides trailing arrow when showTrailingArrow is false', (tester) async {
      await tester.pumpWidget(Harness(
        child: SizedBox(
          width: 400,
          child: DievasAccordion(items: [
            DievasAccordionItem(title: const Text('Item 1'), content: const Text('Content 1'), showTrailingArrow: false),
          ]),
        ),
      ));
      ...
      await tester.pumpWidget(Harness(
        child: SizedBox(
          ...
          child: DievasAccordion(
            ...
            items: [
              DievasAccordionItem(title: const Text('Item 1'), content: const Text('Content 1'), initiallyExpanded: true),
              DievasAccordionItem(title: const Text('Item 2'), content: const Text('Content 2'), initiallyExpanded: true),
            ],
          ),
        ),
      ));
